...
import topBlob from "./SVG/topBlob.svg"
import bottomBlob from "./SVG/bottomBlob.svg"
    ...
    return (
        <section className={styles.PreviewPage} id="Home-preview-page">
            <div className={styles.background}>
                <svg className={clsx("PreviewPage__animate-up-down", styles.topBlob)} width="295" height="388"
                ...
                <svg className={clsx("PreviewPage__animate-up-down", styles.bottomBlob)} width="240" height="388" viewBox="0 0 240 388" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
